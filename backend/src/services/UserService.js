        ...
        console.log("creatEUser")
            ...
            {   
                ...
                if (createdUserId) {
                    ...
                    const emailText = `Hello, you have been invited as ${insertData.user_role} in SD. Please use the below link for joining http://localhost:3001/auth?inviteCode=${invite_code}`;
                    ...
                    data.organization_ids.forEach(async element => {
                        const insertUserOrg = {
                            "user_id": createdUser.id,
                            "organization_id" : element
                        }
                        await db('users_organization').insert(insertUserOrg);
                    });    
                    return createdUser;
                } 
                else {
